...
% Customize section font size (replaces sectsty to avoid underbar/underline warnings)
\makeatletter
...
\usepackage{microtype} % Helps with overfull hbox by enabling character protrusion and font expansion

% Global settings to reduce overfull/underfull hbox warnings
\tolerance=1000 % Allow looser line breaking to avoid overfull hbox
\emergencystretch=3em % Extra stretch for emergency line breaking
\hfuzz=2pt % Ignore overfull hbox warnings smaller than 2pt
...
\usepackage{lmodern} % Required for microtype font expansion; also improves PDF text copying

% For Chinese characters used for the Dao De Jing...
% See https://tex.stackexchange.com/questions/17611/how-does-one-type-chinese-in-latex
%\usepackage{CJKutf8}
...
% resizes the text smaller. Also enables sloppy mode for TOC to avoid overfull
% hbox warnings from long book titles.
\makeatletter
\renewcommand{\l@section}{\@dottedtocline{1}{1.5em}{2.6em}}
\renewcommand{\l@subsection}{\@dottedtocline{2}{4.0em}{3.6em}}
\renewcommand{\l@subsubsection}{\@dottedtocline{3}{7.4em}{4.5em}}
% Wrap tableofcontents to use sloppy mode for better line breaking
\let\oldtableofcontents\tableofcontents
\renewcommand{\tableofcontents}{{\sloppy\oldtableofcontents}}
\makeatother
...
% Note: \textit must be outside \textsc to avoid "italic small caps" font warnings.
\newcommand{\series}[3]{\\\textsc{Part #2 of #3 of the} \textit{\hyperref[series:#1]{#1}} \textsc{series}}
\newcommand{\seriesunlimited}[2]{\\\textsc{Book #2 of the} \textit{\hyperref[series:#1]{#1}} \textsc{series}}
...
\newcommand{\unfinisheddate}[2]{\\\textsc{Started: #1; \hyperref[sec:unfinished_list]{Unfinished}; Abandoned #2}}
